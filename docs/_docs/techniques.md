...
tags: 
 - jekyll
 - github
description: Common techniques to execute shellcode from executable files
---
...
## Storing / Injecting Shellcode

### Overvwrite Program Entrypoint

### Hidden Program Entrypoint Overwrite
